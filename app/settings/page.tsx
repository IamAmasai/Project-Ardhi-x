...
export const metadata: Metadata = {
  title: "Settings | ArdhiX Land Registry System",
  description: "Settings for the ArdhiX Land Registry System",
}
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="id-number" defaultValue="KE123456789" />
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <div className="text-sm text-muted-foreground">Get notified about property status changes</div>
                    </div>
                    <Switch defaultChecked />
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <div className="text-sm text-muted-foreground">Get notified when documents are verified</div>
                    </div>
                    <Switch defaultChecked />
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <div className="text-sm text-muted-foreground">Receive notifications for new logins</div>
                    </div>
                    <Switch defaultChecked />
                  </div>
                  <div className="flex items-center justify-between">
